...
// --------------------
// exec() est utilisé pour la formation de requete ne retournant pas de résultat : INSERT, DELETE, UPDATE.
...
echo 'Derniere id généré par la BDD: '. $pdo->lastInsertId();
...
echo '<hr>';
// ---------------------------------
echo '<h3> 03 - la methode query() et les différents fetch </h3>';
// ---------------------------------

// Au contraire de exec() query() s'utilise pour la formulation retournant un ou plusieurs résultats : SELECT.
...
/* Valeur de retour de la méthode query() :
  -Succès  : elle nous fournit un objet issu de la classe prédéfinie PDOStatement qui contient 1 ou plusieurs jeux de résultats
   -Echec : false
       ...
       Notez que query() peut être ausso utilisée avec INSERT, DELETE et UPTDATE
 */

//  $resultat est le résultat de la requête sous forme inexploitable directement.En effet on ne voit pas le jeux de résult concernat daniel à l'intérieur
// Il faut donc transformer $resultat avec la méthode fetch() :
    ...
    // n'oubliez pas qu'un array ecrit dans des quotes ou des guillemets pers ses quotes à son indice


    // Résumé des 4 étapes principames pour afficher Daniel Chevel
    ...
    # - 4  On affiche ke résultat final
